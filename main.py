...
model = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC_GBC/TMC/lightgbm_model.pkl", "rb"))
scaler = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC_GBC/TMC/scaler.pkl", "rb"))
onehot_encoder = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC_GBC/TMC/onehot_encoder.pkl", "rb"))
...
def get_clean_data():
    data = pd.read_excel("C:/Users/EJ312WS/Downloads/TMC_GBC/TMC/sem2_working_gbc_clean_final.xlsx")
    return data
...
def prediction_page(data):
    ...
    with st.form("prediction_form"):
        ...
        if submitted:
            ...
            st.write(f"- Probability for a patient to DIE due to Gallbladder cancer: {prediction[0]:.2f}")
            st.write(f"- Probability for a patient to be ALIVE due to Gallbladder cancer: {prediction[1]:.2f}")
